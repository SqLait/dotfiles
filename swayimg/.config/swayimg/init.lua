...
swayimg.text.set_foreground(0xFFebdbb2)   -- foreground text color
...
swayimg.gallery.set_border_color(0xFFf2e5bc)        -- border color for selected thumbnail
swayimg.gallery.set_selected_scale(1.05)            -- scale for selected thumbnail
swayimg.gallery.set_selected_color(0xFFd3869b)      -- background color for selected thumbnail
swayimg.gallery.set_unselected_color(0xff202020)    -- background color for unselected thumbnail
swayimg.gallery.set_window_color(0xFF32302f)        -- window background color
